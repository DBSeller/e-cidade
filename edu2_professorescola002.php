...
require_once("classes/db_areatrabalho_classe.php");
...
if ($area==0) {
 ...
 $sFiltroArea =" and ed25_i_codigo = {$area}";
...
for($c=0;$c<$linhas;$c++){
 ...
 $cont++;
 if($disciplina=="S"){
  $result2 = $clrelacaotrabalho->sql_record($clrelacaotrabalho->sql_query("","*","ed25_c_descr"," ed23_i_rechumanoescola = $ed75_i_codigo AND ed23_i_disciplina is not null $sFiltroArea"));
