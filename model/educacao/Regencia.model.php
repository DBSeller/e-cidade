...
class Regencia {
   ...
   * @throws DBException
   */
  public function getTotalHorasAula( $oPeriodoAvaliacao = null ) {
    ...
    $iHorasAulas = ( $this->getTotalDeAulas() * $iMinutos ) / 60;

    if( !empty( $oPeriodoAvaliacao ) && $oPeriodoAvaliacao instanceof PeriodoAvaliacao ) {
      $iHorasAulas = ( $this->getTotalDeAulasNoPeriodo( $oPeriodoAvaliacao ) * $iMinutos ) / 60;
    }
