...
class Turma {
   ...
   * @return Matricula[]
   */
  public function getUltimaMatriculaAlunos( $lOrdenarNome = true ) {

    $aMatriculas      = array();
    $oDaoMatricula    = new cl_matricula();
    $sCamposMatricula = 'max(ed60_i_codigo) as matricula';
    $sOrdenacao       = $lOrdenarNome ? 'ed47_v_nome' : '';
    $sWhereMatricula  = "ed60_i_turma = {$this->iCodigo} and ed221_c_origem = 'S' group by ed60_i_aluno, ed47_v_nome";
