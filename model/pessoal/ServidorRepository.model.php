 ...
 * @return
 */
  public static function getServidoresNoPontoPorFolhaPagamento( FolhaPagamento $oFolhaPagamento ) {
    ...
    $sSqlServidores = $oDaoPonto->sql_query_file($iAno, $iMes, null, null, "distinct {$sSigla}_regist as matricula");
    $rsServidores   = db_query($sSqlServidores);

    if ( !$rsServidores ) {
      throw new DBException("erro"); //@todo
    }
   ...
   * @return
   */
  public static function getServidoresNoCalculoPorFolhaPagamento( FolhaPagamento $oFolhaPagamento ) {
    ...
    $sSqlServidores = $oDaoCalculo->sql_query_file($iAno, $iMes, null, null, "distinct {$sSigla}_regist as matricula");
