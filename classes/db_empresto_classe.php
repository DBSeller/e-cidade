...
$order
    ...
    * @return string
    */
   public function sql_query_restosPagarPorPeriodo($iAnoUsu, $sDataInicial, $sDataFinal, $sInstituicoes, $sCampos = '*') {

     $iAnoUsuAnterior = $iAnoUsu - 1;
     ...
     $sSql .= "                             and e60_anousu = $iAnoUsuAnterior                                                                                            ";
