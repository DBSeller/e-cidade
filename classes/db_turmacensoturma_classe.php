...
class cl_turmacensoturma { 
   ...
   function alterar ($ed343_sequencia=null) { 
      $this->atualizacampos();
   ...
   function excluir ($ed343_sequencia=null,$dbwhere=null) { 
   ...
   // funcao do sql 
   function sql_query ( $ed343_sequencia=null,$campos="*",$ordem=null,$dbwhere=""){ 
     $sql = "select ";
     if($campos != "*" ){
   ...
   // funcao do sql 
   function sql_query_file ( $ed343_sequencia=null,$campos="*",$ordem=null,$dbwhere=""){ 
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = split("#",$campos);
       $virgula = "";
