...
class cl_turmacenso { 
   ...
   function incluir ($ed342_sequencial){ 
      $this->atualizacampos();
     if($this->ed342_censoetapa == null ){ 
       $this->erro_sql = " Campo Etapa Censo não informado.";
       $this->erro_campo = "ed342_censoetapa";
       $this->erro_banco = "";
   ...
   function alterar ($ed342_sequencial=null) { 
     ...
     if(trim($this->ed342_censoetapa)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed342_censoetapa"])){ 
       $sql  .= $virgula." ed342_censoetapa = $this->ed342_censoetapa ";
       $virgula = ",";
       if(trim($this->ed342_censoetapa) == null ){ 
         $this->erro_sql = " Campo Etapa Censo não informado.";
         $this->erro_campo = "ed342_censoetapa";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
