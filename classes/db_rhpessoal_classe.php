...
class cl_rhpessoal {
   ...
   var $campos = "
                 ...
                 rh01_reajusteparidade = bool = Reajuste de Paridade
                 ";
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       ...
       $this->rh01_reajusteparidade = ($this->rh01_reajusteparidade == "f"?@$GLOBALS["HTTP_POST_VARS"]["rh01_reajusteparidade"]:$this->rh01_reajusteparidade); 
     }else{
       $this->rh01_regist = ($this->rh01_regist == ""?@$GLOBALS["HTTP_POST_VARS"]["rh01_regist"]:$this->rh01_regist);
     }
   }
