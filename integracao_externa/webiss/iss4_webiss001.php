...
try {
  ...
  if ( $lInsereConfig ) {
	...
	$aListaAtivPrefeitura  = db_utils::getColectionByRecord($rsAtivPrefeitura); 
	...
	$sSqlSocioPrefeitura .= "        z01_fax    as fax, 					             "; 
	...
	$sSqlGraficaPrefeitura .= "        cgm.z01_fax        as fax,                                             ";
	...
	$aListaGraficaPrefeitura  = db_utils::getColectionByRecord($rsGraficaPrefeitura);	
  ...
  $sSqlEscritorioPrefeitura   .= "       cgm.z01_numero     as numero,                                               ";
	...
	$sSqlEscritorioPrefeitura   .= "       cgm.z01_fax        as fax,                                                  ";
	...
	$aListaEscritorioPrefeitura  = db_utils::getColectionByRecord($rsEscritorioPrefeitura);	
  ...
  $sSqlDadosEmpresa .= "        end as data_abertura,                                                                     ";
	...
	$sSqlDadosEmpresa .= "        cgm.z01_fax        as fax, 											                         ";
      ...
      if ( !validaCpfCnpj($oDadosEmpresa->cpf_cnpj)){
	    ...
	    if ( count($aListaEmpresa) == $iLoteEmpresa || ($iInd+1) == $iLinhasDadosEmpresa ) { 	
		    ...
		    foreach ( $aListaEmpresa as $iIndEmp => $oEmpresa ) {
			    ...
			    $aListaAtivEmpPrefeitura = db_utils::getColectionByRecord($rsAtivEmpPrefeitura);
			    ...
			    $aListaSocioEmpPrefeitura = db_utils::getColectionByRecord($rsSocioEmpPrefeitura);
			    ...
			    $aListaSimplesEmpPrefeitura = db_utils::getColectionByRecord($rsSimplesEmpPrefeitura);
			    ...
			    $aListaEscritoEmpPrefeitura = db_utils::getColectionByRecord($rsEscritoEmpPrefeitura);
			    ...
			    $aListaAidofEmpPrefeitura = db_utils::getColectionByRecord($rsAidofEmpPrefeitura);
			    ...
			    $aListaEstimativaEmpPrefeitura = db_utils::getColectionByRecord($rsEstimativaEmpPrefeitura);
			    ...
			    if ( count($aListaEstimativaEmpPrefeitura) > 0 ) {
			      ...
			      foreach ( $aListaEstimativa as $oEstimativa ) {
			        ...
			        $aListaEstimativaDetalhePrefeitura = db_utils::getColectionByRecord($rsEstimativaDetalhePrefeitura);
