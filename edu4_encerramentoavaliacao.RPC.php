  ...
  case 'encerrarAvaliacoesPorAluno' :
    ...
    try {
      ...
      foreach ($oParam->aTurmas as $oTurmaEtapa) {
        ...
        $oEncerramento->encerrarAvaliacaoTurmaPorAluno($aMatriculas);
        $oRetorno->aTurmasProcessadas[] = $oTurmaEtapa;
 ...
 * @param  array $aCodigoAluno Array com códigos dos alunos
 * @param  Turma $oTurma       Instancia da turma
 * @return Matricula[]
 */
function getMatriculasAlunoTurma ($aCodigoAluno, $oTurma) {
  ...
  foreach ($aCodigoAluno as $iCodigoAluno) {
    ...
    $aMatriculas[] = $oAluno->getMatriculaByTurma($oTurma);
  }
