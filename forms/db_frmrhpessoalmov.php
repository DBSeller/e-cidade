    ...
    <td align="center">
      ...
      <table width="100%" border="0">
       ...
       <tr id="tipoReajuste">
         ...
         <td> 
           <?
             $aTipoReajuste = array('f' => 'Real', 't' => 'Paridade');
...
function js_disabledtipoapos(vinculo) {
  ...
  if ( sVinculo != "" ) {
    ...
    if ( sVinculo != "A" ) {
      ...
      document.getElementById("tipoReajuste").style.display     = "";
      ...
      document.getElementById("rh02_validadepensao").disabled      = true;  
      document.form1.dtjs_rh02_validadepensao.disabled             = true;   
      document.getElementById("tipoReajuste").style.display        = "none";
    }
  } else {
