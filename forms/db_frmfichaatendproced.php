          ...
          <table border="0" width="85%">
            ...
            <tr>
              <td nowrap title="<?=@$Tsd29_t_tratamento?>">
                <label class="bold">Executado:</label>
              </td>
              <td colspan="3">
                <?php
            ...
            <tr>
              ...
              <td>
                <input name="cancelar"
                       ...
                       onclick="location.href='sau4_fichaatendabas003.php?chavepesquisaprontuario=<?=$iProntuario?>'"
                       style="width:170px;">
              </td>
              <td>
...
function js_triagem() {
  ...
  if ($F('sd24_i_codigo') != '') {
    ...
    js_OpenJanelaIframe( '', 'db_iframe_triagemavulsa', sUrl, 'Triagem', true, 20, iLeft, 750, 600 );
  } else {
