        ...
        <tr>
          ...
          <td align="left">
            <?
              ...
              $sql_solicita = $clsolicitem->sql_record($clsolicitem->sql_query_pcmater(null,"distinct pc10_numero,pc10_data,pc10_resumo,descrdepto","pc10_numero desc","pc81_solicitem is null $where_liberado and pc10_correto='t' and  pc10_solicitacaotipo in(1,2) and extract(year from pc10_data) >= ".db_getsession("DB_anousu")));
