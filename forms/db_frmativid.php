...
<form name="form1" method="post" action="">
  <center>
    <fieldset style="width: 500px;">
      <legend><b><?php echo $sAcao; ?> Cadastro de Atividades&nbsp;</b></legend>
      <table border="0" align="center">
            ...
            <div id='PJ' style='visibility:<?php echo $hiddenPJ ?>; position:<?php echo $positionPJ ?>;'>
              <table>
                <tr>
                  ...
                  <td nowrap="nowrap">
                    <?
                    db_input("q71_estrutural", 10, $Iq71_estrutural, TRUE, "text", $db_opcaoselect,
                             "onchange='js_pesquisa_cnae(false);'");
            ...
            <div id='PF' style="visibility:<?php echo $hiddenPF ?>; position:<?php echo $positionPF ?>;">
              <table>
                <tr>
                  ...
                  <td nowrap="nowrap">
                    <?
                    db_input("rh70_estrutural", 10, $Irh70_estrutural, TRUE, "text", $db_opcaoselect,
                             "onchange='js_pesquisa_cbo(false);'");
        ...
        <tr id='servico' style="display: <?php echo $sServicoStyle ?> ">
          ...
          <td align="left" nowrap>
            <?db_input("q127_sequencial", 10, "text", TRUE, "text", $db_opcao,
                       "onchange='js_pesquisa_servico(false);'");
        ...
        <tr>
          ...
          <td colspan="2">
            <?
            db_input('q03_horafim', 10, $Iq03_horafim, TRUE, 'text', $db_opcao,
                     "onchange='js_verifica_hora(this.value,this.name)';");
            ?>
          </td>
        </tr>
