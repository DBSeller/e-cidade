       ...
       <Legend><b>Informações</b></Legend>
         <table width="100%">
          ...
          <tr>
            ...
            <td>
              <? 
                db_input('rh27_rhfundamentacaolegal',10,$Irh27_rhfundamentacaolegal,true,'text',$db_opcao," onchange='js_pesquisaFundamentacaoLegal(false);'");
...
function js_validarFormulario(){
  ...
  if ( $('rh27_rhfundamentacaolegal').value == '' ) {
    alert('Código da Fundamentação Legal não informado.');
    return false;
  }
...
function js_mostrafundamentacao(chave1,chave2,erro){
	document.form1.rh137_descricao.value = chave1+' - '+chave2; 
  if(erro==true){ 
