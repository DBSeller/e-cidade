 ...
 */
var lValidarGrupoDesdobramento = true;
...
function js_saida(oAjax) {
   ...
   * caso variavel global lValidarGrupoDesdobramento for TRUE
   */
  if (lValidarGrupoDesdobramento && (lUsaPCASP == true || lUsaPCASP == 'true')) {

    /**
     * Para nao exibir mais de uma vez
     */
    lValidarGrupoDesdobramento = false;
