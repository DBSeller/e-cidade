...
echo "========================================================================================"
psql -U ${DB_USERNAME} -h ${DB_HOST} -f docker/init.sql && \
psql -U ${DB_USERNAME} -h ${DB_HOST} ${DB_DATABASE} -f docker/ecidade_base.sql && \
psql -U ${DB_USERNAME} -h ${DB_HOST} ${DB_DATABASE} -f docker/pos.sql && \
